...
## Branches
1. The [`main`](https://github.com/fhem/fhem-mirror/tree/main) branch hosts the current source code from [FHEM SVN Trunk](http://svn.fhem.de/fhem/trunk).
2. The [`travis`](https://github.com/fhem/fhem-mirror/tree/travis) branch has the authors file.
...
For that purpose, remember to fork the correct branch [`travis`](https://github.com/fhem/fhem-mirror/tree/travis), _not_ the [`main`](https://github.com/fhem/fhem-mirror/tree/main) branch.
